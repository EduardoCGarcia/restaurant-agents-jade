...
//    }
    ...
    public static void main(String[] args) {
        ...
        ConfigFile configuracion = new ConfigFile("Eduardo",ConfigFile.MODO_CAMARERO, "192.168.100.158", "192.168.100.4", 5000, "C:/restaurant_agents_files/db/productos.dat", "C:/restaurant_agents_files/images/");

        ObjectArrayListSerializerDeserializer<Product> serializerDeserializer =
                new ObjectArrayListSerializerDeserializer<>(configuracion.getRutaArchivoProductos());
        
        
        // Leer la lista de productos desde el archivo
        IData data = new DataImplements();
        ArrayList<Product> productosLeidos = data.readData(configuracion.getRutaArchivoProductos());


        // Mostrar la configuración
        System.out.println("Modo: " + configuracion.getModo());
        System.out.println("IP Propia: " + configuracion.getIpPropia());
        System.out.println("IP Destino: " + configuracion.getIpDestino());
        System.out.println("Puerto: " + configuracion.getPuerto());
        for (Product productosLeido : productosLeidos) {
            System.out.println("Nombre: "+ productosLeido);
        }
        System.out.println("Ruta Imágenes: " + configuracion.getRutaImagenes());
        
        ObjectArrayListSerializerDeserializer<ConfigFile> obj =
                new ObjectArrayListSerializerDeserializer<>("C:/restaurant_agents_files/db/"+configuracion.getUsuario() + "config.dat");
        
        obj.guardarObjetoEnArchivo(configuracion);
    }
}
